...
Given the $\mat{Z}$ matrix defined by Equation 5,
...
## Application of matrix method to useful exergy supply in Ghana

Following 
[Brockway et al. [-@Brockway:2015aa]](https://doi.org/10.1016/j.apenergy.2015.05.082),
one energy aggregate is total useful exergy supplied to the economy ($X_u$).
$X_u$ is comprised of 
...
| $\phi_{p,sc}$   | Allocation ratio of primary exergy to subcategory ($sc$) (Heat, Electric, Mechanical drive, Muscle work)
| $\phi_{sc,ssc}$ | Allocation ratio of exergy from subcategory ($sc)$ to subsubcategory ($ssc$) (MD - Diesel trains, Electric lights, etc.)
| $\eta_{ssc}$    | Thermodynamic efficiency of subsubcategory ($ssc$)
